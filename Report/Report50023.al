report 50023 "Sales - Invoice RDC"
{
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Report/Sales - Invoice RDC.rdl';
    Caption = 'Sales - Invoice RDC';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(Cust_VATReg; Cust."VAT Registration No.")
            {
            }
            ...
            column(gBrand; gBrand)
            {
            }
            column(gOrigin; gOrigin)
            {
            }
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            ManufacturerCode := ItemRec."Vendor Item No.";
                            gOrigin := Origin;
                            gBrand := Brand;
                            HSCode := "HS Code";
                        end;
            ...
            begin
                ...
                IF "Use Bank Account" <> '' THEN Begin
                    IF RecBankAcc.GET(CompanyInfo.Name, "Use Bank Account") THEN begin

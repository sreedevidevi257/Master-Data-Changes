report 50005 "Prometal Sales - Pro Forma Inv"
{
  // version T20190513.0006
  UsageCategory = ReportsAndAnalysis;
  ApplicationArea = All;
  DefaultLayout = RDLC;
  RDLCLayout = './ReportLayout/Prometal/Prometal Sales - Pro Forma Inv.rdl';
  ...
  begin
    ...
    ProFormaInvNo:='PI' + DelStr("No.", 1, 2);
  end;
  }
  }
  requestpage

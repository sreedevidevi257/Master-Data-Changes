report 50002 "Sales - Invoice Prometal"
{
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    // RDLCLayout = './Report/Prometal/Sales - Invoice Prometal.rdl';
    RDLCLayout = './ReportLayout/Prometal/Sales - Invoice Prometal Mesam.rdl';
    //RDLCLayout = './Report/Prometal/Sales - InvoicemetalTAG.rdl';
    Caption = 'Sales - Invoice Prometal';
    ...
    dataset
    {
        ...
        "Sales Invoice Header")
        {
            ...
            column(g_CountryrRegion; g_CountryrRegion.Name)
            {
            ...
            column(VariableHeading1;
            VariableHeading[1])
            {
            }
            column(VariableHeading_2;
            VariableHeading[2])
            {
            }
            column(VariableHeading_3;
            VariableHeading[3])
            {
            }
            column(VariableHeading_4;
            VariableHeading[4])
            {
            }
            column(VariableHeading_5;
            VariableHeading[5])
            {
            }
            column(VariableHeading_6;
            VariableHeading[6])
            {
            }
            column(VariableHeading_7;
            VariableHeading[7])
            {
            }
            column(VariableHeading_8;
            VariableHeading[8])
            {
            }
            ...
            "Integer")
            {
                ...
                "Integer")
                {
                    ...
                    FORMAT("Sales Invoice Header"."Due Date", 0, '<Day,2>/<Month,2>/<Year4>'))
                    {
                    }
                    ...
                    FORMAT("Sales Invoice Header"."Document Date", 0, '<Day,2>/<Month,2>/<Year4>'))
                    {
                    }
                    ...
                    column(BlanketSalesOrder_Caption;
                    BlanketSalesOrderNoLbl)
                    {
                    }
                    column(BlanketSalesOrderNo_;
                    "Sales Invoice Header"."Blanket  Order No.")
                    {
                    }
                    column(ProjectName_Caption;
                    ProjectNameCaptionLbl)
                    {
                    }
                    column(ProjectName_;
                    "Sales Invoice Header"."Project  Code")
                    {
                    }
                    column(ScopeOfWork_Caption;
                    ScopeOfWorkCaptionLbl)
                    {
                    }
                    column(ScopeOfWork;
                    "Sales Invoice Header"."Scope of work")
                    {
                    }
                    column(ExtDocument_No;
                    "Sales Invoice Header"."External Document No.")
                    {
                    }
                    column(DeliveryNoteNo_;
                    "Sales Invoice Header"."Delivery Note No.")
                    {
                    }
                    column(CompRegNoCaptionLbl;
                    CompRegNoCaptionLbl)
                    {
                    }
                    column(CountryName;
                    ...
                    dataitem("Sales Invoice Line";"Sales Invoice Line")
                    {
                        ...
                        column(VATLineAmount; "Amount Including VAT" - Amount)
                        {
                        ...
                        column(HSCode;_HSCode){}
                        column(CountryRegionCodeName;_CountryRegionCodeName){}
                        ...
                        column(CustRef_;
                        "Sales Invoice Line"."Cust. Ref #")
                        {
                        }
                        column(Size_;
                        "Sales Invoice Line"."Size_")
                        {
                        }
                        column(DoorType_;
                        "Sales Invoice Line"."Door  Type/No.")
                        {
                        }
                        column(FireRating_;
                        "Sales Invoice Line"."Fire  Rating")
                        {
                        }
                        column(STCRating_;
                        "Sales Invoice Line"."STC  Rating")
                        {
                        }
                        column(CustRef_Caption;
                        CustRefCaptionLbl)
                        {
                        }
                        column(Size_Caption;
                        ...
                        column(DoorType_Caption;
                        DoorTypeCaptionLbl)
                        {
                        }
                        column(FireRating_Caption;
                        FireRatingCaptionLbl)
                        {
                        }
                        column(STCRating_Caption;
                        STCRatingCaptionLbl)
                        {
                        }
                        column(PDN__No_;
                        "Sales Invoice Line"."PDN  No.")
                        {
                        }
                        column(Layout_Type;
                        LayoutType)
                        ...
                        column(VariableDetail_1;
                        VariableDetail[1])
                        {
                        }
                        column(VariableDetail_2;
                        VariableDetail[2])
                        {
                        }
                        column(VariableDetail_3;
                        VariableDetail[3])
                        {
                        }
                        column(VariableDetail_4;
                        VariableDetail[4])
                        {
                        }
                        column(VariableDetail_5;
                        VariableDetail[5])
                        {
                        }
                        column(VariableDetail_6;
                        VariableDetail[6])
                        {
                        }
                        column(VariableDetail_7;
                        VariableDetail[7])
                        {
                        }
                        column(VariableDetail_8;
                        VariableDetail[8])
                        {
                        }
                        ...
                        trigger OnAfterGetRecord(); //line on after
                        begin
                            ...
                            IF LayoutType = LayoutType::Door THEN BEGIN
                                ...
                                VariableDetail[2] := '';
                                VariableDetail[3] := "Description";
                                VariableDetail[4] := '';
                                VariableDetail[5] := "Size_";
                                VariableDetail[6] := "Door  Type/No.";
                                VariableDetail[7] := "Fire  Rating";
                                VariableDetail[8] := "STC  Rating";
                            END
                            ELSE BEGIN
                                VariableDetail[1] := "No.";
                                VariableDetail[2] := "Description";
                                VariableDetail[3] := '';
                                VariableDetail[4] := "Description 2";
                                VariableDetail[5] := '';
                                VariableDetail[6] := '';
                                VariableDetail[7] := Brand;
                                VariableDetail[8] := '';
                            END;
                            ...
                            //@@HA
                            Clear(_HSCode);
                            Clear(_CountryRegionCodeName);
                            case "Sales Invoice Line".Type of
                            "Sales Invoice Line".Type::Item:
                                begin
                                  IF  tbl_Item.Get("Sales Invoice Line"."No.") then
                                    begin

                                        IF (("Sales Invoice Header"."Ship-to Country/Region Code" ='KSA')or ("Sales Invoice Header"."Ship-to Country/Region Code" ='SAU')) THEN
                                        BEGIN
                                            _HSCode:=tbl_Item."HS Code KSA"
                                        END ELSE
                                        begin 
                                            _HSCode:= tbl_Item."Tariff No.";
                                        END;
                                    END;
                                        tbl_CountryRegion.Reset();
                                        tbl_CountryRegion.SetRange(Code, tbl_Item."Country/Region of Origin Code");
                                        if tbl_CountryRegion.FindSet() then
                                         _CountryRegionCodeName:= tbl_CountryRegion.Name;
                                end;
                ...
                trigger OnPostDataItem();
                begin
                    if not CurrReport.PREVIEW then CODEUNIT.RUN(CODEUNIT::"Sales Inv.-Printed", "Sales Invoice Header");
                end;
            ...
            trigger OnAfterGetRecord();
            var
                RecBankAcc: Record "Additional Bank Account";
            ...
            begin
                ...
                IF "Use Bank Account" <> '' THEN Begin
                    //IF RecBankAcc.get(CompanyName,"Use Bank Account") THEN  begin                    
                ...
                END;
                IF LayoutType = LayoutType::Door THEN BEGIN
                    VariableHeading[1] := 'PDN#';
                    VariableHeading[2] := '';
                    VariableHeading[3] := 'Description';
                    VariableHeading[4] := '';
                    VariableHeading[5] := 'Size';
                    VariableHeading[6] := 'Door Type';
                    VariableHeading[7] := 'Fire Rating';
                    VariableHeading[8] := 'STC Rating';
                END
                ELSE BEGIN
                    VariableHeading[1] := 'Item Code';
                    VariableHeading[2] := 'Description';
                    VariableHeading[3] := '';
                    VariableHeading[4] := 'Description 2';
                    VariableHeading[5] := '';
                    VariableHeading[6] := '';
                    VariableHeading[7] := 'Brand';
                    VariableHeading[8] := '';
                END;
                IF CustomerRec.get("Sell-to Customer No.") THEN begin
                    CompRegNo := CustomerRec."Trade License No.";
                    IF not Country.get(CustomerRec."Country/Region Code") THEN Country.Init;
                end;
    ...
    begin
        ...
        SalesSetup.GET;
        CompanyInfo.GET;
        g_CountryrRegion.Reset();
        Clear(g_CountryrRegion);
        g_CountryrRegion.SetRange(Code, CompanyInfo."Country/Region Code");
        if g_CountryrRegion.FindFirst() then;
    ...
    var
        ...
        _HSCode:Code[20];
        _CountryRegionCodeName:Text[50];
        tbl_CountryRegion:Record "Country/Region";
        _terifNoHSCode:Text[250];
        Text004: TextConst Comment = '%1 = Document No.', ENU = 'Sales - Invoice %1';
        PageCaptionCap: Label 'Page %1 of %2';
        GLSetup: Record "General Ledger Setup";
        AdditionalBankAccont: Record "Additional Bank Account";
        ...
        ProjectNameCaptionLbl: Label 'Project Code';
        ScopeOfWorkCaptionLbl: Label 'Scope of work';
        DNCaptionLbl: Label 'DN#';
        CustRefCaptionLbl: Label 'Cust Ref #';
        PDNNoCAptionLbl: Label 'PDN#';
        ...
        BankName: Text[50];
        g_CountryrRegion: Record "Country/Region";
        IBAN: Code[50];
        SWIFT: Code[20];
        VariableHeading: array[8] of Text;
        VariableDetail: array[8] of Text;
        LayoutType: Option Door,Hardware;
        Desr2CAptionLbl: Label 'Description 2';
        CountryNameText: Text[50];
        CompRegNoCaptionLbl: Label 'Company Reg. No.';
        CompRegNo: Code[20];
